import 'package:chatproject/bottomBarUi/bottombar2.dart';
import 'package:chatproject/bottomBarUi/bottombar3.dart';
import 'package:chatproject/bottomBarUi/bottombar4.dart';
import 'package:chatproject/data/categoriesData.dart';
import 'package:chatproject/data/concertdata.dart';
import 'package:chatproject/models/database_helper.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flashy_tab_bar2/flashy_tab_bar2.dart';
import 'package:snapping_sheet/snapping_sheet.dart';
import 'package:chatproject/models/picture.dart';
...
class _ExploreEventsPageState extends State<ExploreEventsPage> {
  ...
  //     return dataBaseHelper!.addPicture(Picture(value)).then((value) {
  //       dataBaseHelper!.takePicture().then((mobileData) {
  //         for (var readData in mobileData) {
  //           allpicture!.add(Picture.fromMap(readData));
  //         }
